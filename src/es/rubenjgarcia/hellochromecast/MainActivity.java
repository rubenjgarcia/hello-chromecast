package es.rubenjgarcia.hellochromecast;
...
public class MainActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		EditText castText = (EditText) findViewById(R.id.castText);
		castText.addTextChangedListener(new TextWatcher() {
							...
							new ResultCallback<Cast.ApplicationConnectionResult>() {
								...
								public void onResult(ApplicationConnectionResult result) {
									...
									if (status.isSuccess()) {
										...
										// on the receiver
										sendMessage(getString(R.string.hello_world));
									} else {
